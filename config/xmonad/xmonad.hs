...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- play/pause spotifyd    
    , ((0               ,  0x1008FF14), spawn "zsh ~/scripts/play_pause.sh")

    -- next song spotifyd    
    , ((0               ,  0x1008FF17), spawn "playerctl --player=spotifyd next")

    -- previous song spotifyd    
    , ((0               ,  0x1008FF16), spawn "playerctl --player=spotifyd previous")

    -- increase volume
    ,((0                , 0x1008FF13 ), spawn "pamixer -u & pamixer -i 10")

    -- decrease volume
    ,((0                , 0x1008FF11 ), spawn "pamixer -u & pamixer -d 10")
    ...
    , ((modm .|. shiftMask, xK_p     ), spawn "bash ~/.config/rofi/powermenu/powermenu.sh")
    ...
    -- screenshot
    , ((modm .|. shiftMask, xK_f     ), spawn "import -window root screenshot1.png")
